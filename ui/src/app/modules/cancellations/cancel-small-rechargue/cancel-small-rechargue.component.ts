...
export class CancelSmallRechargueComponent implements OnInit {
    ...
    public cancellationSmallRechargeForm: FormGroup; 
  ...
  constructor(private titleService: Title,
              ...
              private modalService: BsModalService
                ...
                this.cancellationSmallRechargeForm = this.formBuilder.group({ 
  ...
  addItems(items){
    let itemsArray = this.cancellationSmallRechargeForm.get('items') as FormArray;
  ...
  closeModal(){
    ...
    let forms = this.cancellationSmallRechargeForm.get("items") as FormArray
  ...
  search(ev){
    ...
    if(ev.formData.numFactura !== null || ev.formData.numCuenta !== null || ev.formData.numContrato !== null || ev.formData.numIdCliente !== null ){
      ...
      if (ev.formData.numFactura !== '' || ev.formData.numCuenta !== '' || ev.formData.numContrato !== '' || ev.formData.numIdCliente !== '') { 
        ...
        this.cancelSmallRechargeService.search(ev.formData.numFactura, ev.formData.numCuenta, ev.formData.numContrato, ev.formData.numIdCliente).subscribe(
          data => {
  ...
  public clearFormData(ev){
    // console.log(ev);
    this.cancellationSmallRechargeForm.reset()
    this.cancellationSmallRechargeForm = this.formBuilder.group({
  ...
  onSelect({ selected }) {
    ...
    let items = this.cancellationSmallRechargeForm.get("items") as FormArray
    ...
    listSelected.forEach(e=>{
      let currentItem  = (this.cancellationSmallRechargeForm.get("items") as FormArray).at(e);
  ...
  continue(){
    ...
    console.log("Form ", this.cancellationSmallRechargeForm.getRawValue())
    let items = this.cancellationSmallRechargeForm.get('items') as FormArray
